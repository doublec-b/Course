...
import major from "../views/admin/major/major.vue"
import courseManage from "../views/admin/courseManage/courseManage.vue"
import userCourseManage from "../views/admin/userCourseManage/userCourseManage.vue"


import home2 from "../views/static/home/home.vue"
import shcoolManage2 from "../views/static/schoolManage/schoolManage.vue"
import departmentManage2 from "../views/static/departmentManage/departmentManage.vue"
import major2 from "../views/static/major/major.vue"
import courseManage2 from "../views/static/courseManage/courseManage.vue"
import userCourseManage2 from "../views/static/userCourseManage/userCourseManage.vue"
...
const routes = [
    {
        ...
        name: 'index', //命名路由
        component: () => import('../views/static/login.vue')   //key:value  默认//页面组件 components 普通组件 页面组件和普通组件是一对多
    },
    {
        path: '/home2',
        name: 'home2',
        ...
        children: [
            {
                path: 'schoolManage2',
                name: 'schoolManage2',
                component: shcoolManage2
            },
            {
                path: 'departmentManage2',
                name: 'departmentManage2',
                component: departmentManage2
            },
            {
                path: 'major2',
                name: 'major2',
            ...
            },
            {
                path: 'courseManage2',
                name: 'courseManage2',
                component: courseManage2
            },
            {
                path: 'userCourseManage2',
                name: 'userCourseManage2',
                component: userCourseManage2
            },
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'userCourseManage',
                component: userCourseManage
            },
        ]
    },
    {
