    ...
    <button @click="userStore.increat">count++</button> -->
        <div class="login-form">
            ...
            <el-form ref="ruleFormRef" :model="userForm" status-icon :rules="rules" class="login-ruleForm">
                ...
                <div class="mb-2 flex items-center text-sm" style="margin-left: 45px;">
                    <el-radio-group v-model="right" class="ml-4">
                ...
                if (valid) {
                    ...
                    res.then(result => {
                        ...
                        if (result.success) {
                            ...
                            that.right == 1 ? that.$router.push('/home') : that.$router.push('/home2')
